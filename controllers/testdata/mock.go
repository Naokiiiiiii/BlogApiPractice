...
func (s *serviceMock) UpdateArticleService(articleID int, article models.UpdateArticle) error {
	return nil
}
...
func (s *serviceMock) UpdateCommentService(commentID int, updateComment models.UpdateComment) error {
	return nil
}
